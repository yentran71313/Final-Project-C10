...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    @Query("SELECT NEW com.cg.model.dto.customerDTO.CustomerResDTO(cus.id, cus.fullName, cus.email,cus.phoneNumber,cus.image.fileUrl, cus.locationRegion.provinceName, cus.locationRegion.districtName, cus.locationRegion.wardName, cus.locationRegion.provinceId, cus.locationRegion.wardId, cus.locationRegion.districtId,cus.locationRegion.address,cus.image.id) " +
